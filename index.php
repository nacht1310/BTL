...
?>
 	...
 	<div class="thucdonct wow fadeInUp">
 		<div class="tieudect text-xs-center fontroboto">
 			...
 			<a href="" data-monan=".sang">Cà phê và trà</a>
 			<a href="" data-monan=".trua">Bánh Ngọt</a>
 			<a href="" data-monan=".toi">Quà tặng</a> 
 		</div>
 		<div class="noidungct">
 			 <div class="container">
 			 			...
 			 			<div class="row">
 			 				...
 			 				<div class="col-xs-9 col-sm-8">
 			 					<div class="tenmon">
									  ...
									  <a class="btn btn-warning wow bounce" data-wow-iteration="3" href="#" >Mua</a>
 			 					</div>
 			 				</div>
 			 			</div> <!-- het row -->
 			 		</div>  <!-- het motmon -->
